...
public class Empregado  extends Ordenavel 
{	
...
//	}
	...
	{	return numero == ((Integer)num).intValue();
   	...
   	public int comparar(Ordenavel b)//precisa sobrepor. evita sobrecarga(mesmo metodo  com mesmo nome e lista de argumentos diferente)
	{
