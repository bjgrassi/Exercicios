...
{	public static void main (String[] args)
	{	final int TAM = Console.readInt('\n' + "Informe o tamanho da lista de empregados: ");
		...
		{	System.out.println('\n' + "==============================================================");
			...
			System.out.println("6. Lista empregados ordenados ascendentemente por salário");
			...
			{	case 1:
				...
				case 6:	// Lista empregados ordenados ascendentemente por salário. 
					int tam = listaDeEmpregados.tamanho();
					if (tam > 0)
					{	Empregado[] vetEmpregados = new Empregado[tam];
										
						vetEmpregados[0] = listaDeEmpregados.recuperarPrimeiro(); 
												
						for (int i = 1; i < tam; i++)
						{	vetEmpregados[i] = listaDeEmpregados.recuperarProximo();
						}
												
						Ordenacao.ordena(vetEmpregados);

						System.out.println(" "); 
						for (int i = 0; i < tam; i++)
							System.out.println(	"Número = " + vetEmpregados[i].getNumero() + 
												"   Nome = " + vetEmpregados[i].getNome() +
												"   Salario = " + vetEmpregados[i].getSalario());
					}
					else
						System.out.println('\n' + "Não há empregados na lista."); 
